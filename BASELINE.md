...
## Older release-gate baselines

0.8.2 / 0.8.1 / 0.8.0 (including the 0.8.0 Opus 4.8 first operator interview)
and the 0.5.0 context-pressure / compaction-policy baseline have moved to
`CHANGELOG.md` and git history. They are not repeated here — this section keeps
only the most recent recorded baseline above as the live calibration reference.
