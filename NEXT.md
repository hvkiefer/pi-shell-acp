# NEXT — entwurf post-0.12.3: mux-agnostic spawn surface + PR #40 cortex
...
- **0.12.3 floor 검증(post-release, 미완):** 오라클 clean reinstall(`pnpm add -g @junghanacs/entwurf@0.12.3` → `entwurf install-meta-bridge` → `doctor-meta-bridge`)로 floor 호스트 end-to-end. thinkpad 단독은 거짓 안심.
